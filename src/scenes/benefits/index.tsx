...
import BenifitsPageGraghic from '@/assets/BenefitsPageGraphic.png'
...
const Benefits = ({ setSelectedPage }: Props) => {
    return (
        <section id="benefits" className="mx-auto min-h-full w-5/6 p-20">
            <motion.div
            ...
            >
                ...
                <motion.div
                    ...
                    variants={container}
                >
                    {benifits.map((benifit: BenifitType, index: number) => (
                        <Benefit
                            key={index + 1}
                            icon={benifit.icon}
                            title={benifit.title}
